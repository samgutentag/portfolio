...
summary: "Some, actually all, assembly required."
...
<PartsList title="Materials" items={[
  { name: "ORICO 2.5\" USB3.0 SATA External Hard Drive Enclosure", qty: 1, link: "https://www.amazon.com/dp/B00B0RD2RA" },
  { name: "Seagate FireCuda Gaming (Compute) 2TB Solid State Hybrid Drive Performance SSHD", qty: 1, link: "https://www.amazon.com/dp/B01M1NHCZT" },
]} />
...
Perform the reverse of Step 3, sliding the cover up on the guide rails until it snaps gently back
into place.
...
<Callout variant="tip">
Give the Case with the installed Hard Drive a gentle shake, you should not hear any rattling
