...
summary: "Twitter Marks The Spot"
...
<TerminalBlock language="bash" title="install prerequisites">
...
[Pieces for Developers](https://twitter.com/getpieces) titled "AI for Developer Productivity" which
...
<TerminalBlock language="bash" title="example network entry">
...
<TerminalBlock language="bash" title="navigate to downloads">
cd ~/Downloads
</TerminalBlock>

Use `yt-dlp` to download the spaces recording with this command:

<TerminalBlock language="bash" title="download the recording">
{`yt-dpl https://prod-fastly-us-east-1.video.pscp.tv/Transcoding/v1/hls/cxIaV_kOVKtVFbsr-rugYE7nlh8BEqogOW-AsQwgF4n5q7I9ve0B_DrmtotFaAEpYpmMJ7A3G8BTdBnNukeHJQ/non_transcode/us-east-1/periscope-replay-direct-prod-us-east-1-public/audio-space/playlist_16732160847824420797.m3u8?type=replay`}
</TerminalBlock>
