...
<GitHubCard repo="samgutentag/meal-plan-vscode" description="VS Code extension for generating weekly meal plans" language="TypeScript" />

<GitHubCard repo="samgutentag/meal-plan-cursor" description="Cursor-built version of the meal plan generator for comparison" language="TypeScript" />
