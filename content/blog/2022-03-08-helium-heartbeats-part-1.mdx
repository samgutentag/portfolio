...
summary: "Can't Stop, Wont Stop, (Probably Should Stop) Refreshing."
...
<Callout variant="note">A change in status is when a Hotspot has been innactive for more than a specified number of Blocks, I use `450` for my "inactive" status.</Callout>
