---
title: "❤️ Monitor Helium Hotspot Activity Part 1: Overview and Heartbeats"
summary: "Can't Stop, Won't Stop, (Probably Should Stop) Refreshing."
...
<Callout variant="note">these are not my actual hotspots, they are associated to a wallet I selected at random.</Callout>

---

## What is a "Heartbeat"?

The "Hotspot Heartbeat" is a snapshot of hotspot status at a specific point in time, this script
...
<Callout variant="note">A change in status is when a Hotspot has been inactive for more than a specified number of Blocks, I use `450` for my "inactive" status.</Callout>
