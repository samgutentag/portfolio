...
That's it, now extensions like [markdownlint][markdownlint-link], [Markdown Preview
...
<TIL>Adding `"*.mdx": "markdown"` to your VSCode `settings.json` file associations makes all your markdown extensions (preview, linting, snippets) work on MDX files.</TIL>
