...
<Callout variant="tip">You can fork the repo, edit `data.js` with your restaurants, push to GitHub, and you're live.</Callout>
...
<TIL>The real barrier to shipping side projects isn't technical skill — it's activation energy. AI tools collapse the distance between "I should build this" and "it's live."</TIL>

---

The map is live at [https://sbburgerweekmap.com](https://sbburgerweekmap.com). Fork it and map your own burger week!
