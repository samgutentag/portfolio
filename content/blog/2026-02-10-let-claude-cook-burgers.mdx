...
Santa Barbara Burger Week is back. Every year, dozens of restaurants across the city (and surrounding area, woo!) serve up $10 specialty burgers for a week long event, and the primary source of truth is a single article in [The Independent](https://www.independent.com/2026/02/05/burger-week-2026/).
...
I described the _outcome_ I wanted in plain English, and Claude Code figured out the implementation. I did not give pseudo-code, I didn't draw up architecture diagrams, I simply wrote out my intent.
