...
summary: "Push to wait, to talk, to wait, to talk."
...
<TIL>You don't need WaveLink to use an Elgato Wave mic with Zoom on macOS — the mic works as a standard USB audio device.</TIL>
