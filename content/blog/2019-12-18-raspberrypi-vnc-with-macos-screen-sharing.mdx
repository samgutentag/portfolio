...
<TerminalBlock language="bash" title="error message">
...
<TerminalBlock language="bash" title="open raspi-config">
> sudo raspi-config
</TerminalBlock>
...
<TerminalBlock language="bash" title="reboot">
> sudo reboot -h now
</TerminalBlock>
...
<TerminalBlock language="bash" title="set vnc password">
...
<TerminalBlock language="bash" title="common.custom">
...
<TerminalBlock language="bash" title="restart vnc server">
...
<TerminalBlock language="bash" title="get ip address">
> ifconfig
</TerminalBlock>
...
<TIL>The macOS Screen Sharing "incompatible" error with Raspberry Pi VNC is fixed by switching the auth scheme to `VncAuth` instead of the default.</TIL>
