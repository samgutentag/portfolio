...
<PartsList title="Outdoor Enclosure Kit Contents" items={[
  { name: "PVC Tape", qty: 1 },
  { name: "Self Sealing Waterproof Tape", qty: 1 },
  { name: "RG1.32 Antenna Cable", qty: 1 },
  { name: "Outdoor Enclosure Body", qty: 1 },
  { name: "Outdoor Enclosure Lid", qty: 1 },
  { name: "Hotspot Mounting Plate", qty: 1 },
  { name: "Mounting Arm", qty: 1 },
  { name: "Pole/Wall Mounting Brackets", qty: 2 },
  { name: "Enclosure Back Plate", qty: 1 },
  { name: "POE Splitter", qty: 1 },
  { name: "POE Injector", qty: 1 },
...
<PartsList title="Extra Tools" items={[
  { name: "10mm socket, deeper is better", qty: 1 },
  { name: "Screw Driver or Drill", qty: 1 },
  { name: "Level", qty: 1 },
  { name: "Ladder", qty: 1 },
  { name: "Common Sense", qty: 1 },
  { name: "Safety Precautions", qty: 1 },
]} />
...
The Back Plate attaches to the rear of the Enclosure, be mindful of the orientation of the Back
...
<Callout variant="warning">I assume no responsibility for the next steps, you are at your own risk and this information is provided as an informational resource only. BE SAFE, falling off of roofs or other elevated platforms and locations can be fatal. Hire a Professional Installer if you have **any** doubt in your safety or abilities.</Callout>
...
<Callout variant="note">Quick Note on POE connections. The POE Injector has 2 Ethernet Ports, connect the one labelled "POE" to your Hotspot and the one labelled "LAN" to your modem/router.</Callout>
