...
Both of these needed manual fixes. Metabase got `viewBox="0 0 178 42"` (computed by hand from the transform math). Cockroach Labs was restored to its original `viewBox="0 0 534 102"` which was already correct.
