...
summary: "Clipping coupons, with code."
publishedAt: "2019-06-04"
---

## I'm Tired Of Tapping
...
<GitHubCard repo="samgutentag/safewayClipper" description="Automate clipping Safeway digital coupons with Selenium" language="Python" />
...
several times had I written this post when I first got started.
...
aside from my laptop won't be doing anything else at that time.
